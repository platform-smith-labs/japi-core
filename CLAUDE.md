...
## Platform Smith Project

This repository is part of the **Platform Smith** project. For cross-repository documentation, architecture overview, and repo locations, see:

- **Project Documentation**: `../platform-smith-project.md`
- **All Repos**: Located under `../`
